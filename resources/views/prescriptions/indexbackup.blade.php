...
@if (count($prescriptions) > 0)
  ...
  <div class="col-sm-12 mb-3">
    <input type="text" id="myFilter" class="form-control d-flex" onkeyup="filterCards(this)" placeholder="Szukaj...">
  </div>
  <style media="screen">
    .card.hidden {
  ...
  <hr class="hr-primary">
    @foreach ($prescriptions as $prescription)
      ...
      <p class="card-text">
        <b>{{$prescription->doctor->FullName}}</b>
        <hr>
...
@else
  <div class="row">
    ...
    <div class="col-8">
      <a class="btn btn-primary float-right" href="/prescriptions/create">Dodaj receptę</a>
    </div>
